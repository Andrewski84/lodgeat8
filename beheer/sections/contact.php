 ...
 *
 * Contact details are site-wide fields saved through save-general. The page
 * text and form-enabled toggle are page-specific content saved through
 * save-page. Technical mail settings are intentionally not edited here; they
 * are managed directly in storage/mail-settings.json on the server.
 */
